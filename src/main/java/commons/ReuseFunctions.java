...
public class ReuseFunctions {
	...
	public void clickToDynamicButton(String buttonName) {
		waitForElementVisible(CommonPageUI.DYNAMIC_BUTTON,buttonName);
		clickToElement(CommonPageUI.DYNAMIC_BUTTON, buttonName);
	}
	...
	public String getTextDynamicPageHeading(String textValue) {
		waitForElementVisible(CommonPageUI.DYNAMIC_PAGE_HEADING,textValue);
		return getTextElement(CommonPageUI.DYNAMIC_PAGE_HEADING, textValue);
	}
	
	public void selectDynamicDropDownList(String dropdownName,String valueItem) {
		waitForElementVisible(CommonPageUI.DYNAMIC_DROPDOWN_LIST,dropdownName);
		selectItemInDropdown(CommonPageUI.DYNAMIC_DROPDOWN_LIST, valueItem, dropdownName);
	}
}
