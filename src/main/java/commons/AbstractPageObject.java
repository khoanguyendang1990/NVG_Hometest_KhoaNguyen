...
public class AbstractPageObject {
	...
	public boolean isElementActived(String locator) {
		element = find(locator);
	...
	public LoginPageObject openLoginPage() {
		waitForElementVisible(AbstractPageUI.HEADER_TO_LOGIN_LINK);
		clickToElement(AbstractPageUI.HEADER_TO_LOGIN_LINK);
